...
mysql_query("UPDATE `ward_members` SET Email='$phpemail', Password='$phppass', First_Name='$phpfirstname', Last_Name='$phplastname', QuorumID='$phpquorum', WardID='$phpward', Phone='$phpphone', Spouse_Name='$phpspouse', Is_Admin='$phpisadmin' WHERE MemberID='$phpmembaid' AND WardID='$phpward' ") or die(mysql_error());

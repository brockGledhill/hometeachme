...
<div id="topbar">
    ...
    <a class="topbtn selectedtab" href="#" title="notifications"><span class="glyphicon glyphicon-bell" ></span></a>
...
<?php include('menu.php'); ?>
    ...
    <h4 class="pagetitles">0 Notifications</h4>
   
   	<p class="exptext">You have 0 notifications at this time</p>
